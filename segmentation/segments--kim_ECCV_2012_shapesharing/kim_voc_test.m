B1;3402;0cfunction kim_voc_test(SECTIONS, section_no)
    SetupPath;
    ...
    for voc_idx = start_idx:end_idx
        ...
        num_segs(voc_idx) = size(masks,3);
        seg_time(voc_idx) = timing.t_all;
        
        save([img_name '_scores.mat'], 'Q', 'collated_scores', 'avg_best_overlap', 'num_segs', 'seg_time');
    ...
    save('result.mat', 'avg_best_overlap', 'num_segs', 'seg_time');
end
