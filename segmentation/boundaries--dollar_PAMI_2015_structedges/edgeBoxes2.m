...
if(0), 
    E=gradientMag(convTri(single(I),4)); E=E/max(E(:)); 
end
T=edgesNmsMex(E,O,2,0,1,model.opts.nThreads);
[bbs,V,segIds,edgeArr]=edgeBoxesMex2(T, O, o.alpha, o.beta, o.eta, o.minScore, o.maxBoxes,...
                     o.edgeMinMag, o.edgeMergeThr, o.clusterMinMag,...
                     o.maxAspectRatio, o.minBoxArea, o.gamma,o.kappa);
%                  fprintf(1, '\n');
% [bbs2,V2]=edgeBoxesMex(T, O, o.alpha, o.beta, o.eta, o.minScore, o.maxBoxes,...
%                      o.edgeMinMag, o.edgeMergeThr, o.clusterMinMag,...
%                      o.maxAspectRatio, o.minBoxArea, o.gamma,o.kappa);
