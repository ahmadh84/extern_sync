function [ranked_regions superpixels image_data unary] = generate_proposals(input)
...
[ranking overlaps unary] = rankProposals(image_data, proposals, proposal_features, w);
