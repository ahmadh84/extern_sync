...
include{1} = fullfile(root_dir, 'src', 'auxs');  % To get matlab_multiarray.hpp
...
build_file{end+1} = fullfile(root_dir, 'src', 'auxs'     ,'mex_intersect_hierarchies.cpp');
build_file{end+1} = fullfile(root_dir, 'src', 'auxs'     ,'mex_ucm2hier.cpp');
build_file{end+1} = fullfile(root_dir, 'src', 'auxs'     ,'mex_cands2masks.cpp');
build_file{end+1} = fullfile(root_dir, 'src', 'auxs'     ,'mex_cands2labels.cpp');
